...
Man sieht, dass bei keiner Variablen des Datensatzes "affairs" ein fehlender Wert (NA) existierst. Dieselbe Überprüfung kann auch pro Spalte erfolgen. Aus Übersichtsgründen wurde die Ausgabe des Befehls hier unterdrückt.
```{r, results='hide'}

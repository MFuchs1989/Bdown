...
Der Chi^2 Test zeigt ein nicht signifikantes Ergebnis (chi^2=0,15, df=1,p=.702). Dies bedeutet, dass die Häufigkeitsverteilung in unserer Stichprobe nicht bedeutsam von er Häufigkeitsverteilung in der Population abweicht. 
...
Das Ergebnis ist signifikant (chi^2=7,39, df=1, p<.001). Männer sind demnach häufiger Raucher mehr als Frauen. 

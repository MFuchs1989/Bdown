...
$$  s = \frac{|1-6|+|3-6|+|5-6|+|9-6|+|12-6|}{5} =\frac{(5+3+1+3+6)}{5} =3,6  $$
...
$$  Varianz  = \frac{((1-6)^2+(3-6)^2+(5-6)^2+(9-6)^2+(12-6)^2)}{5} =\frac{(25+9+1+9+36)}{5} =16  $$
...
$$  s^2  = \frac{((1-6)^2+(3-6)^2+(5-6)^2+(9-6)^2+(12-6)^2)}{5-1} =\frac{(80)}{4} =20  $$
...
$$  Standardabweichung  = \frac{(\sqrt{(1-6)^2}+\sqrt{(3-6)^2}+\sqrt{(5-6)^2}+\sqrt{(9-6)^2}+\sqrt{(12-6)^2})}{\sqrt{5}} =\frac{\sqrt{80}}{\sqrt{5}} =4  $$
...
$$  \sqrt{s^2}  = \frac{(\sqrt{(1-6)^2}+\sqrt{(3-6)^2}+\sqrt{(5-6)^2}+\sqrt{(9-6)^2}+\sqrt{(12-6)^2})}{\sqrt{(5-1)}} =\frac{\sqrt{80}}{\sqrt{4}} =4,47  $$
...
$$  Variationskoeffizient  = \frac{Standardabweichung}{Mittelwet} =\frac{4}{6} =0,67 = 66,7\%  $$
...
$$  Spannweite  = Maximum - Minimum = 12 - 1 = 11  $$
...
$$  IQR  = 3.Quartil - 1.Quartil = 11,75-5,50 = 6,25  $$

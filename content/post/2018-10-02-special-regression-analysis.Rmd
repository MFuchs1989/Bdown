...
summary(mediate(y = affairs.normal ~ age.cen + (education.cen), data = affairs))
```
...
Der Sobel Test überprüft anschließend noch den indirekten Effekt auf signifikanz.
```{r}
mediation.test(education.cen, age.cen, affairs.normal)
```

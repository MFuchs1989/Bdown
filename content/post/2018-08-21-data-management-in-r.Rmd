...
##Special Case 1: Different variables within a Data Frame
...
##special case 2: Combine Observations with different colnames 
...
##Special case 1: Combine variables by one variable with different spellings
...
Anstelle des by - Argumentes gibt es nun die Zusatzargumente *by.x* und *by.y*.  Mit *by.x* wird die Schreibweise der Namesspalte aus Dataframe "Mzp32 festgelegt und mit *by.y* die Schreibweise aus Dataframe "Mzp4". 
```{r}
...
##Special case 2: Combine variables with with different number of observations 

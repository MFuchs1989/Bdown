...
+ 1 Introduction
+ 2 Preparation
+ ["3 Scatter Plot with slider input"](https://michael-fuchs-stat.shinyapps.io/P24B/)
+ ["4 Scatter Plot plus Density Plot "](https://michael-fuchs-stat.shinyapps.io/P24C/)
+ ["5 Scatter Plot plus Correlation"](https://michael-fuchs-stat.shinyapps.io/P24D/)
+ ["6 Scatter Plot plus regression analysis"](https://michael-fuchs-stat.shinyapps.io/P24E/)
+ 7 Conclusion
...
#3 Scatter Plot with slider input 
...
#4 Scatter Plot plus Density Plot
...
#5 Scatter Plot plus Correlation
...
#6 Scatter Plot plus regression analysis
